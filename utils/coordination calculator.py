...
# enter the axis the arm rotate about and the angle to calculate the rotation matrix
def rot(axis, theta):
    Rx = np.array([[1, 0, 0],
...
def rotation1(axis1, theta1, axis2, theta2, axis3, theta3):
    print(rot(axis1, theta1), "\n", rot(axis2, theta2), "\n", rot(axis3, theta3))
    return np.matmul(np.matmul(rot(axis1, theta1), rot(axis2, theta2)), rot(axis3, theta3))
